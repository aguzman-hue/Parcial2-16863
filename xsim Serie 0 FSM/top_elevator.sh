...
#
# Script generated by Vivado on Thu Sep 18 08:21:18 -0600 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : top_elevator.sh
...
#
# Usage        : top_elevator.sh
#                top_elevator.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                top_elevator.sh [-reset_run]
#                top_elevator.sh [-reset_log]
#                top_elevator.sh [-help]
#
...
# script info
echo -e "top_elevator.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./top_elevator.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot top_elevator xil_defaultlib.top_elevator xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top_elevator -key {Behavioral:sim_1:Functional:top_elevator} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_elevator.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./top_elevator.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: top_elevator.sh [-help]\n\
Usage: top_elevator.sh [-step]\n\
Usage: top_elevator.sh [-lib_map_path]\n\
Usage: top_elevator.sh [-reset_run]\n\
Usage: top_elevator.sh [-reset_log]\n\
Usage: top_elevator.sh [-keep_index]\n\
Usage: top_elevator.sh [-noclean_files]\n\n\
