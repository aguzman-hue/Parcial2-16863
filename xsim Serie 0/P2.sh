...
#
# Script generated by Vivado on Mon Sep 15 23:57:35 -0600 2025
...
#
# Usage        : P2.sh
#                P2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                P2.sh [-reset_run]
#                P2.sh [-reset_log]
#                P2.sh [-help]
#
...
# script info
echo -e "P2.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./P2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot P2 xil_defaultlib.P2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim P2 -key {Behavioral:sim_1:Functional:P2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb P2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./P2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: P2.sh [-help]\n\
Usage: P2.sh [-step]\n\
Usage: P2.sh [-lib_map_path]\n\
Usage: P2.sh [-reset_run]\n\
Usage: P2.sh [-reset_log]\n\
Usage: P2.sh [-keep_index]\n\
Usage: P2.sh [-noclean_files]\n\n\
